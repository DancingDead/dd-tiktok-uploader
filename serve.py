...
À utiliser sur la tour Windows, derrière le tunnel Cloudflare. Waitress
écoute en local (127.0.0.1) ; seul cloudflared, sur la même machine, s'y
connecte et expose le dashboard en HTTPS sur app.dancingdeadrecords.com.
...
def main() -> None:
    # On est toujours derrière le proxy HTTPS de Cloudflare en production.
