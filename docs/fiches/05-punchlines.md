...
| `mode` | `"llm"` | `"fixe"` = texte manuel, `"llm_unique"` = une punchline générée, stable du début à la fin (consigne `long` : deux lignes qui s'opposent, 6 à 12 mots chacune, demandées comme deux éléments de tableau puis recollées) |
